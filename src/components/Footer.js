...
const Footer = () => {
  return (
    <div className="flex flex-col  w-full h-screen py-[8rem] text-center md:py-[28rem] ">
      <div className="md:w-2/3 w-full px-4 text-[#595959] flex flex-col mx-auto">
        ...
        <div className="flex mt-8 flex-col md:flex-row md:justify-between">
          ...
          <div className="w-44 mx-auto pt-6 md:pt-0">
            <a className="bg-blue-600 justify-center text-center text-white rounded-lg shadow px-10 py-3 flex items-center">
              Contact US
            </a>
          </div>
        </div>
        <div className="flex flex-col ">
          <div className="flex mt-24 mb-12  flex-row justify-between">
            <a
              href="/about"
              className="md:block cursor-pointer text-gray-600 hover:text-white uppercase"
            >
              About
            </a>
            <a
